...
export const phases = [
  ...
  ['Product quality', ['lint:chat', 'verify:content:strict', 'lint:design-system:strict', 'check', 'build', 'verify:wave1-launch-truth:built', 'verify:pagefind-a11y', 'verify:final-product-acceptance', 'verify:markdown-processor:built', 'verify:katex-assets:built', 'verify:pdf-exports', 'lint:a11y:strict', 'check:contrast', 'check:corpus:strict', 'verify:compiled-runtime-vars']],
