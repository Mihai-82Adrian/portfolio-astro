...
or by Phase 2D-C Wave 1. Dependabot alerts/automated security fixes, CodeQL default setup, and
required-check/branch-protection consolidation were later implemented under Phase 3-B2; see
[docs/ROADMAP.md](../ROADMAP.md) for current status — this document records the scope decision, not
a live implementation tracker.
