...
baseline: Dependabot, CodeQL, branch-protection/ruleset hardening) is next, and Phase 3-B3
(operational monitoring automation) is planned after it; Phase 3-C (human and provider release
readiness) is planned after Phase 3-B. Secure intake, external APIs, portals, queues, provider
abstraction, and Workers Static Assets remain trigger-based or optional rather than implied features.
