...
- GitHub/Cloudflare deployment ownership and required-check inventory are read-only verified
  ...
  a permission denial); preview validation is Phase 3-B1 work, and remaining security-baseline
  hardening and provider readiness are Phase 3-B2/3-B3/3-C work.
...
Phase 3-B1 (public-safe preview and Cloudflare automatic-deployment control) is active, Phase 3-B2
(repository security baseline: Dependabot, CodeQL, branch-protection/ruleset hardening) is next, and
Phase 3-B3 (operational monitoring automation) is planned after it; Phase 3-C (human and provider
release readiness) is planned after Phase 3-B. Secure intake, external APIs, portals, queues,
